/******/ ;(() => {
  ...
  function setPreferredVersions(dependencies) {
    ...
    for (const [name, version] of Object.entries(dependencies || {})) {
      const preferredVersion =
        allPreferredVersions === null || allPreferredVersions === void 0
          ? void 0
          : allPreferredVersions.get(name)
      if (
        preferredVersion &&
        !((_a =
          allowedAlternativeVersions === null || allowedAlternativeVersions === void 0
            ? void 0
            : allowedAlternativeVersions.get(name)) === null || _a === void 0
          ? void 0
          : _a.has(version))
      ) {
  ...
  const hooks = {
    ...
    afterAllResolved: (lockfile, context) => {
      ...
      return (
        (_a = userPnpmfile === null || userPnpmfile === void 0 ? void 0 : userPnpmfile.hooks) ===
          null || _a === void 0
          ? void 0
          : _a.afterAllResolved
      )
    ...
    readPackage: (pkg, context) => {
      ...
      return (
        ...
        ? userPnpmfile.hooks.readPackage(pkg, context)
        : pkg
    },
    // Call the original pnpmfile (if it exists)
    filterLog:
